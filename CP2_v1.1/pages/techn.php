    ...
    <main class="main-wrap">
        ...
        <section class="showcase">
            ...
            <!-- ============================================================
                 ...
                 6 columns: ID | Subject | Category | Priority | Status |
                            Action (Update Status — outlined button)
            ...
            <div class="page-content" id="page-tickets">
                ...
                <!--
                    Toolbar: filter tabs only (no New Ticket button —
                    technicians work on assigned tickets, not create new ones).
                -->
                ...
                <!--
                    6-column ticket table using .ttcol-* classes.
                    Action column holds an outlined "Update Status" button —
                    visually lighter than admin's filled "Assign" button.
                    Body shows empty state until backend is wired up.
                -->
                <div class="tickets-list">
                    <div class="tickets-list-header">
                        <span class="ttcol-id">ID</span>
                        <span class="ttcol-subject">Subject</span>
                        <span class="ttcol-category">Category</span>
                        <span class="ttcol-priority">Priority</span>
                ...
                <div class="mailbox-container">
                    ...
                    <aside class="mailbox-threads">
                        ...
                        <div class="mailbox-threads-list">
                            <div class="mailbox-threads-empty">
                                ...
                                <p>Once you're assigned a ticket and message its owner, the conversation will appear here.</p>
                            </div>
                        </div>
                    </aside>
                    ...
                    <div class="mailbox-chat">
                        <div class="mailbox-chat-empty">
                            ...
                            <p class="mailbox-chat-empty-sub">Select a conversation from the left to view messages with the ticket owner.</p>
                        </div>
                    </div>
